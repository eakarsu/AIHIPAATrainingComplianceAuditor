...
// Auto-generated page for: No breach-simulation tabletop endpoint

export default function GapNoBreachSimulationTabletopEndpoint() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-breach-simulation-tabletop-endpoint', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No breach-simulation tabletop endpoint</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No breach-simulation tabletop endpoint</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No breach-simulation tabletop endpoint'}
        </button>
      </form>
