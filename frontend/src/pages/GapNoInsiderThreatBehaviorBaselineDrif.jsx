...
// Auto-generated page for: No insider-threat behavior-baseline drift detector

export default function GapNoInsiderThreatBehaviorBaselineDrif() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-insider-threat-behavior-baseline-drif', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No insider-threat behavior-baseline drift detector</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No insider-threat behavior-baseline drift detector</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No insider-threat behavior-baseline drift detector'}
        </button>
      </form>
