...
// Auto-generated page for: OCR + policy automation extracting requirements from PDFs an

export default function CfOcrPolicyAutomationExtractingRequire() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-ocr-policy-automation-extracting-require', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>OCR + policy automation extracting requirements from PDFs an</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>OCR + policy automation extracting requirements from PDFs and cross-referencing org policies.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run OCR + policy automation extracting requirements from PDFs an'}
        </button>
      </form>
