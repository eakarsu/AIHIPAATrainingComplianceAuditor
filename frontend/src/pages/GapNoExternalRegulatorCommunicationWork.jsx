...
// Auto-generated page for: No external regulator communication workflows

export default function GapNoExternalRegulatorCommunicationWork() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-external-regulator-communication-work', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No external regulator communication workflows</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No external regulator communication workflows</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No external regulator communication workflows'}
        </button>
      </form>
