...
// Auto-generated page for: Limited vendor-security-assessment depth (BAA review exists 

export default function GapLimitedVendorSecurityAssessmentDepth() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-vendor-security-assessment-depth', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Limited vendor-security-assessment depth (BAA review exists </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Limited vendor-security-assessment depth (BAA review exists but no continuous posture monitoring)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Limited vendor-security-assessment depth (BAA review exists '}
        </button>
      </form>
