...
// Auto-generated page for: Vendor risk management ingesting SOC 2 / HITRUST reports and

export default function CfVendorRiskManagementIngestingSoc2() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-vendor-risk-management-ingesting-soc-2', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Vendor risk management ingesting SOC 2 / HITRUST reports and</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Vendor risk management ingesting SOC 2 / HITRUST reports and prioritizing renegotiation.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Vendor risk management ingesting SOC 2 / HITRUST reports and'}
        </button>
      </form>
